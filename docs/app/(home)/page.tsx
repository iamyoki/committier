...
export default function HomePage() {
  return (
    <div className="flex flex-1">
      <div
        className="max-w-340 flex max-lg:flex-col items-center justify-center
      ...
      >
        <div className="flex flex-col items-start max-lg:items-center">
          ...
          >
            <Link
              href="https://github.com/iamyoki/committier/releases"
              target="_blank"
            >
              🚀 AI is now available in Beta
            </Link>
        ...
        text-transparent bg-clip-text bg-linear-to-r from-fd-primary to-[#26EE87]/60"
            >
              committier
            </h1>
          </div>
          ...
          <div className="mt-3 max-w-3xl ml-1">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              Make your commits PRO with ease.
            </p>
          </div>
          ...
          <div className="flex flex-col  sm:flex-row gap-4 mt-8">
            <Link
              href="/docs"
              className="w-full sm:w-auto px-5 py-3 font-bold bg-fd-secondary hover:text-fd-primary text-fd-foreground rounded-full transition-all flex items-center justify-center gap-2 group"
            >
              Get Started
